      ...
      <Container maxWidth='md' sx={{ padding: 2 }}>
        ...
        <Stack rowGap={2} paddingY={3}>
          ...
          <Typography variant='body2'>
            ...
            have a lot on their plates, and we&rsquo; ve designed our software
            to be intuitive and easy to use. Our interface is straightforward
            and our workflows are streamlined, so you can spend less time
            navigating software and more time working with students.
          </Typography>
          <Typography variant='body2'>
