...
function ConfirmStudent({ open, setOpen, setMode }) {
  ...
  const onSubmit = () => {
    // console.log(personal, photo, medical, parent, academic);
  ...
  const primaryStyle = { fontSize: 11, color: 'primary' };
      ...
      <DialogContent>
        ...
        >
          ...
          >
            ...
            <Stack justifyContent='center' alignItems='flex-end' width='100%'>
